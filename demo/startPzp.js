...
var ipAddr = 'localhost' , port = 8000, serverPort = 8081, webServerPort = 8080;
...
if (ipAddr === '' || port <= 0) {
	...
	pzp.startWebSocketServer(ipAddr, serverPort, webServerPort);
	pzp.startPzp(contents, ipAddr, port);
}
