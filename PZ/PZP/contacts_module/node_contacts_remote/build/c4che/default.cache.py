...
CPPPATH_LIBGCAL = ['/usr/include/libgcal', '/usr/include/libxml2']
...
HAVE_LIBGCAL = 1
LIBDIR = '/home/SERILOCAL/habib.virji/.node_libraries'
LIBPATH_NODE = '/usr/local/lib'
LIBPATH_ST = '-L%s'
LIB_LIBGCAL = ['gcal', 'curl', 'xml2']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/SERILOCAL/habib.virji/.node_libraries'
PREFIX = '/usr/local'
